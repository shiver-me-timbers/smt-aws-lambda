...
public class Maps {
    ...
    public static Map<String, Object> createCustomResourceRequest(Map<String, Object> values) throws IOException {
        return createMap("custom-resource-request.mustache", values);
    }
