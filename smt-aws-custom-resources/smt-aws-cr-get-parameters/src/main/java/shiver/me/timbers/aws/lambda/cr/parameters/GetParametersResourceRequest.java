 ...
 * @author Karl Bennett
 */
class GetParametersResourceRequest extends CustomResourceRequest {
    GetParametersResourceRequest(CustomResourceRequest request) {
        super(
    ...
    List<String> getParameterNames() {
        return (List<String>) getResourceProperties().get("ParameterNames");
    }
}
